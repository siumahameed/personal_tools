                ...
                <table class="data-table">
                  ...
                  <tbody>
                    <tr v-for="(cost, cIdx) in sortedCosts" :key="cIdx">
                      ...
                      <td>{{ cost.tuition === 0 ? 'FREE' : cost.tuition_currency + ' ' + cost.tuition }}</td>
                      <td>{{ cost.tuition_currency === 'EUR' ? '€' : '$' }}{{ cost.rent }}</td>
                      <td>{{ cost.blocked_account > 0 ? (cost.tuition_currency === 'EUR' ? '€' : '$') + cost.blocked_account.toLocaleString() : 'Not Required' }}</td>
