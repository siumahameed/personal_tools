...
class DeadlineTracker:
            ...
            for dl_str, label in deadlines_to_check:
                ...
                for raw_dl in dl_str.split(";"):
                    ...
                    results.append({
                        ...
                        "url": u.get("department___faculty_url") or u.get("dept_url", ""),
    ...
    def save_alerts(self):
        path = os.path.join(os.path.dirname(__file__), "..", "..", "data", "deadline_alerts.json")
        with open(path, "w", encoding="utf-8") as f:
            json.dump(self.alerts, f, indent=2, ensure_ascii=False)

    def _save_for_dashboard(self, results):
        path = os.path.join(os.path.dirname(__file__), "..", "..", "data", "deadlines.json")
        with open(path, "w", encoding="utf-8") as f:
