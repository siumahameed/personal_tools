...
8. NEVER use placeholder text like [insert], [Your Name], [your], [email], [phone], [Professor's Name], [University], [details], [etc]. Use actual data from the profile. If a detail is missing from the profile, omit it entirely rather than using a placeholder.
